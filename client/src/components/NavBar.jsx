...
export const RightNav = () => {
  ...
  const navigate = useNavigate();
  const { setIsLive, setIsPost, setIsReel, setUploadPopup } = useAppContext();
  ...
  return (
    <>
      <div className="rightNav">
        ...
        >
          <Profile profile={datas.admin.profile} isAccount={true} />
        </div>
      </div>
...
export function Profile({ profile, isStory, isOnline, isAccount }) {
  const navigate = useNavigate();
  return (
